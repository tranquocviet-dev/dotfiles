...
vim.cmd.highlight('StatusLine guibg=None guifg=#878580')
vim.cmd.highlight('TabLine guibg=None guifg=#575653')
vim.cmd.highlight('TabLineSel guibg=None guifg=#CECDC3')
